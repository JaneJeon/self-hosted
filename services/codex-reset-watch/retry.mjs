// Retry helpers, kept separate from the monitor so they can be imported by
...
// judgement. For the tracker API a 404 is a real bug; for the Uptime Kuma
// heartbeat it is routinely transient (see run.mjs).
